...
export const ServerChannel = ({
  ...
  return ( 
    <button onClick={() => {}} className={cn("group p-2 flex rounded-md items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1", params?.channelId === channel.id  && "bg-zinc-700/20 dark:bg-zinc-700")}>
      ...
      {channel.name !== "general" && role !== MemberRole.GUEST && (
        <div className="ml-auto flex-items flex gap-x-2">
